...
class E14(AbstractFitness):
    ...
    def __init__(self) -> None:
        ...
        self.x6_set = [random.randint(0, 10) for _ in range(self.data_points)]
    ...
    def evaluate(self, individual):
        ...
        for i in range(self.data_points):
            ...
            x5 = self.x5_set[i]
            x6 = self.x6_set[i]
            inputs_dict = {"x1": x1, "x2": x2, "x3": x3, "x4": x4, "x5": x5, "x6": x6}
            measured = (x5 * x6) / ((x1 * x3) / (x2 * x4))
