...
class E12(AbstractFitness):
    ...
    def __init__(self) -> None:
        ...
        self.x7_set = [random.randint(0, 10) for _ in range(self.data_points)]
        self.x8_set = [random.randint(0, 10) for _ in range(self.data_points)]
        self.x9_set = [random.randint(0, 10) for _ in range(self.data_points)]
        self.x10_set = [random.randint(0, 10) for _ in range(self.data_points)]
