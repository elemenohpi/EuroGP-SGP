...
# plotter.plot_experiment(
# 	["../OGP_Results/08-04-2022/ControlProblems_Acrobat_noretcon/Evo", "../OGP_Results/08-04-2022/ControlProblems_Acrobat_retcon/Evo", "../OGP_Results/08-04-2022/ControlProblems_Acrobat_spatial/Evo"],
# 	100, "Fitness over Generation for solving the Acrobat Problem", "Generations", "Fitness (Penalty for Low Free End Altitude)", ["Prog", "Prog RetCon", "Spatial"])
#
#
# plotter.plot_experiment(
# 	["../OGP_Results/08-04-2022/ControlProblems_CartPole_noretcon/Evo", "../OGP_Results/08-04-2022/ControlProblems_CartPole_retcon/Evo", "../OGP_Results/08-04-2022/ControlProblems_CartPole_spatial/Evo"],
# 	100, "Fitness over Generation for solving the Cart Pole Problem", "Generations", "Fitness (Successful Steps)", ["Prog", "Prog RetCon", "Spatial"])
# #
# plotter.plot_experiment(
...
# plotter.plot_experiment(
# 	["../OGP_Results/08-04-2022/ToyProblems_Adventure_noretcon/Evo", "../OGP_Results/08-04-2022/ToyProblems_Adventure_retcon/Evo", "../OGP_Results/08-04-2022/ToyProblems_Adventure_spatio/Evo"],
# 	500, "Fitness over Generation for Solving the Adventure Problem", "Generations", "Fitness (Score Achieved)", ["Prog", "Prog RetCon", "Spatial"])
...
plotter.plot_experiment(
	[ "../OGP_Results/DEAP_Results/TreeGP_ObstacleAvoidance/Slurm"],
	300, "Fitness over Generation for Solving the Santa-Fe Ant Variation", "Generations", "Fitness (Count of Food Gathered)", ["RetCon", "RetCon Loop", "Spatial", "Spatial Loop"])
